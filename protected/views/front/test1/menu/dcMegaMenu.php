...
<hr/>
<?php
$this->widget('my.widgets.dcMegaMenu.JDcMegaMenu', array(
    'selector' => '#mega-menu-1',
    'skin' => 'grey', //black | blue | green | grey | light_blue | orange |red | white
    'options' => array(
        'debug' => true,
...
<div class="demo-container">
    <h3>Skin: Grey, Items Per Row: 2, Speed: Fast, Effect: Fade In, Event: Hover</h3>
