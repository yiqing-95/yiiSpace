...
CREATE TABLE `admin_menu` (
  ...
  KEY `rgt` (`rgt`),
  KEY `level` (`level`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='用nestedset保存树关系';

/*Data for the table `admin_menu` */

insert  into `admin_menu`(`id`,`root`,`lft`,`rgt`,`level`,`label`,`url`,`params`,`ajaxoptions`,`htmloptions`,`is_visible`,`uid`,`group_code`) values (8,8,1,52,1,'top_virtual_root',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu_root'),(9,8,6,9,2,'RELATIONS',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(10,8,2,5,2,'HOME',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(11,8,10,17,2,'user',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(12,8,7,8,3,'relationTypes','/friend/relationshipType/admin',NULL,NULL,NULL,1,0,'sys_admin_menu'),(14,8,13,14,3,'User Profile Manager','/user/profileField/admin',NULL,NULL,NULL,1,0,'sys_admin_menu'),(16,8,11,12,3,'用户管理','/user/admin/admin',NULL,NULL,NULL,1,0,'sys_admin_menu'),(18,8,15,16,3,'新增用户profile字段','/user/profileField/create',NULL,NULL,NULL,1,0,'sys_admin_menu'),(19,8,18,21,2,'modules',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(20,8,19,20,3,'manage','/module/admin',NULL,NULL,NULL,1,0,'sys_admin_menu'),(27,8,22,25,2,'评论管理',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(28,8,23,24,3,'管理','/comments/comment/admin',NULL,NULL,NULL,1,0,'sys_admin_menu'),(29,8,26,43,2,'test',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(30,8,27,32,3,'controllerId',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(31,8,28,29,4,'actinId',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(32,8,30,31,4,'actinId2',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(33,8,39,42,3,'controllerId2',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(34,8,40,41,4,'actinId',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(35,8,33,38,3,'testx',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(36,8,34,37,4,'ppp',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(37,8,3,4,3,'index',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(38,8,35,36,5,'hello',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(39,8,44,47,2,'auth','/auth',NULL,NULL,NULL,1,0,'sys_admin_menu'),(40,8,45,46,3,'权限管理','/auth/assignment/index',NULL,NULL,NULL,1,0,'sys_admin_menu'),(41,8,48,51,2,'api 管理',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(42,8,49,50,3,'api 客户端管理','/apiPlatform/apiClient/admin',NULL,NULL,NULL,1,0,'sys_admin_menu');
...
insert  into `photo_rating`(`pt_id`,`pt_rating_count`,`pt_rating_sum`) values (7,6,25),(5,3,10),(6,5,20),(10,3,15),(9,2,8),(14,3,15),(17,2,7),(16,3,11),(15,4,16),(19,2,8),(18,2,6),(13,1,5),(11,1,5),(12,1,3),(21,2,9),(20,1,5),(23,1,3),(8,1,3),(22,1,3),(24,2,10),(26,1,5),(28,1,5);
...
insert  into `photo_view_track`(`id`,`viewer`,`ip`,`ts`) values (10,1,0,1354295444),(7,1,0,1354295801),(6,1,0,1354295834),(6,2,0,1354295922),(7,2,0,1354295977),(9,1,0,1354297211),(5,1,0,1354334958),(14,2,16777343,1356794262),(15,2,16777343,1356792377),(10,2,16777343,1354686988),(17,2,16777343,1354963048),(5,2,16777343,1354442196),(13,1,16777343,1354518829),(6,0,16777343,1354554312),(17,0,16777343,1354673645),(5,0,16777343,1354554792),(15,0,16777343,1355202146),(14,1,16777343,1355369339),(18,1,16777343,1354603897),(14,0,16777343,1354673645),(15,1,16777343,1355242405),(7,0,16777343,1354716174),(8,1,16777343,1355371952),(19,1,16777343,1363450189),(19,0,16777343,1354724009),(17,1,16777343,1354726037),(11,1,16777343,1359599859),(18,0,16777343,1355038837),(18,2,16777343,1354972425),(19,2,16777343,1354972548),(20,1,16777343,1358487618),(21,1,16777343,1357144042),(22,2,16777343,1356849166),(23,2,16777343,1355401167),(23,0,16777343,1355217621),(22,1,16777343,1356849998),(22,0,16777343,1361458948),(23,1,16777343,1356857352),(24,1,16777343,1356939047),(21,2,16777343,1356507220),(25,2,16777343,1356859525),(24,0,16777343,1357469484),(25,1,16777343,1362918852),(26,1,16777343,1360512728),(27,1,16777343,1363082241),(26,0,16777343,1363021841),(28,1,16777343,1363450394),(28,0,16777343,1363451494);
...
insert  into `user`(`id`,`username`,`password`,`email`,`activkey`,`superuser`,`status`,`create_at`,`lastvisit_at`) values (1,'yiqing','32ee7d239bcc2eff68f47ca70bd6e4a7','webmaster@example.com','8abda1b47ccc436c2aaf3eb5912d3971',1,1,'2012-07-24 15:46:36','2013-04-05 14:52:40'),(2,'yiqing2','32ee7d239bcc2eff68f47ca70bd6e4a7','66104992@qq.com','c1a5a5f7d1cc198d132d2d367ca08877',0,1,'2012-07-27 10:29:01','2013-01-16 04:51:30'),(3,'yiqing3','32ee7d239bcc2eff68f47ca70bd6e4a7','yiqing_95@qq.com','f07550b610f3388b17ffc6b62aecb1ad',0,1,'2012-08-11 14:15:02','2013-02-10 16:15:44'),(4,'tewt','test','ceshi@qq.com','',0,0,'2013-03-24 18:53:49','0000-00-00 00:00:00');
...
insert  into `yiisession`(`id`,`expire`,`data`,`user_id`) values ('2ste1qcl5eojne5s3e3i4g8385',1365582552,'admin__isAdmin|b:1;admin__returnUrl|s:71:\"/my/MyGithubProjects/yiiSpace/admin.php/auth/assignment/index/menuId/40\";admin__id|s:1:\"1\";admin__name|s:6:\"yiqing\";admin__states|a:0:{}adminis_admin_action|b:1;adminactiveTopMenuId|s:2:\"41\";adminadminTopMenu|a:2:{s:10:\"api 管理\";s:0:\"\";s:19:\"api 客户端管理\";s:77:\"/my/MyGithubProjects/yiiSpace/admin.php/apiPlatform/apiClient/admin/menuId/42\";}ea7393d1cc9e1969b4c77702b7cf53db__id|s:1:\"1\";ea7393d1cc9e1969b4c77702b7cf53db__name|s:6:\"yiqing\";ea7393d1cc9e1969b4c77702b7cf53db__states|a:0:{}',1);
