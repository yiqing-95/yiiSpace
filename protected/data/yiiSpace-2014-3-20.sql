...
CREATE TABLE `admin_menu` (
  ...
  KEY `rgt` (`rgt`),
  KEY `level` (`level`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='用nestedset保存树关系';

/*Data for the table `admin_menu` */

insert  into `admin_menu`(`id`,`root`,`lft`,`rgt`,`level`,`label`,`url`,`params`,`ajaxoptions`,`htmloptions`,`is_visible`,`uid`,`group_code`) values (8,8,1,58,1,'top_virtual_root',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu_root'),(9,8,6,9,2,'RELATIONS',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(10,8,2,5,2,'HOME',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(11,8,10,17,2,'user',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(12,8,7,8,3,'relationTypes','/friend/relationshipType/admin',NULL,NULL,NULL,1,0,'sys_admin_menu'),(14,8,13,14,3,'User Profile Manager','/user/profileField/admin',NULL,NULL,NULL,1,0,'sys_admin_menu'),(16,8,11,12,3,'用户管理','/user/admin/admin',NULL,NULL,NULL,1,0,'sys_admin_menu'),(18,8,15,16,3,'新增用户profile字段','/user/profileField/create',NULL,NULL,NULL,1,0,'sys_admin_menu'),(19,8,18,21,2,'modules',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(20,8,19,20,3,'manage','/module/admin',NULL,NULL,NULL,1,0,'sys_admin_menu'),(27,8,22,27,2,'评论管理',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(28,8,25,26,3,'管理','/comments/comment/admin',NULL,NULL,NULL,1,0,'sys_admin_menu'),(29,8,28,49,2,'test',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(30,8,33,34,3,'controllerId',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(31,8,29,30,3,'actinId',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(32,8,44,45,4,'actinId2',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(33,8,31,32,3,'controllerId2',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(34,8,39,40,3,'actinId',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(35,8,35,38,3,'testx',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(36,8,36,37,4,'ppp',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(37,8,3,4,3,'index',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(38,8,42,43,4,'hello',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(39,8,41,48,3,'auth','/auth',NULL,NULL,NULL,1,0,'sys_admin_menu'),(40,8,46,47,4,'权限管理','/auth/assignment/index',NULL,NULL,NULL,1,0,'sys_admin_menu'),(41,8,50,53,2,'api 管理',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(42,8,51,52,3,'api 客户端管理','/apiPlatform/apiClient/admin',NULL,NULL,NULL,1,0,'sys_admin_menu'),(43,8,54,57,2,'系统',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu'),(44,8,55,56,3,'系统菜单','/sysMenu/admin',NULL,NULL,NULL,1,0,'sys_admin_menu'),(45,8,23,24,3,'sdfsdf',NULL,NULL,NULL,NULL,1,0,'sys_admin_menu');
...
CREATE TABLE `news_category` (
  ...
  KEY `rgt` (`rgt`),
  KEY `level` (`level`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='用nestedset保存树关系';

/*Data for the table `news_category` */

insert  into `news_category`(`id`,`root`,`lft`,`rgt`,`level`,`name`,`enable`,`group_code`,`mbr_count`,`link_to`) values (33,33,1,10,1,'顶级虚拟分类',1,'news_cate',0,'route'),(34,33,2,3,2,'sub-测试分类1',1,'news_cate',0,'route'),(35,33,4,9,2,'sub-测试分类2',1,'news_cate',0,'route'),(37,33,7,8,3,'测试分类4',1,'news_cate',0,'route'),(38,33,5,6,3,'测试分类5',1,'news_cate',0,'route');
...
insert  into `news_entry`(`id`,`creator`,`cate_id`,`title`,`order`,`deleted`,`create_time`) values (5,6,0,'iuyiu',0,0,1365318706),(6,6,0,'呵呵呵呵呵呵呵呵',0,0,1365318729),(7,6,0,'hi girls！',0,0,1365320372);
...
insert  into `news_post`(`nid`,`content`,`keywords`,`meta_title`,`meta_description`,`meta_keywords`) values (5,'好几个和交换机交换机呵呵呵',NULL,NULL,NULL,NULL),(6,'ujjkljhhhhghhjhjhj\r\n',NULL,NULL,NULL,NULL),(7,'<p>就急急急急急急</p><p>ssdfskdjflksa</p><p>sd卡福建省拉看大家</p><p>sd卡解放路撒 <br></p>',NULL,NULL,NULL,NULL);
...
insert  into `photo_view_track`(`id`,`viewer`,`ip`,`ts`) values (10,1,0,1354295444),(7,1,0,1354295801),(6,1,0,1354295834),(6,2,0,1354295922),(7,2,0,1354295977),(9,1,0,1354297211),(5,1,0,1354334958),(14,2,16777343,1370773043),(15,2,16777343,1356792377),(10,2,16777343,1354686988),(17,2,16777343,1354963048),(5,2,16777343,1354442196),(13,1,16777343,1354518829),(6,0,16777343,1354554312),(17,0,16777343,1354673645),(5,0,16777343,1354554792),(15,0,16777343,1355202146),(14,1,16777343,1355369339),(18,1,16777343,1354603897),(14,0,16777343,1354673645),(15,1,16777343,1355242405),(7,0,16777343,1354716174),(8,1,16777343,1355371952),(19,1,16777343,1363450189),(19,0,16777343,1354724009),(17,1,16777343,1354726037),(11,1,16777343,1359599859),(18,0,16777343,1355038837),(18,2,16777343,1354972425),(19,2,16777343,1354972548),(20,1,16777343,1358487618),(21,1,16777343,1357144042),(22,2,16777343,1356849166),(23,2,16777343,1370772968),(23,0,16777343,1355217621),(22,1,16777343,1356849998),(22,0,16777343,1371241859),(23,1,16777343,1356857352),(24,1,16777343,1371605948),(21,2,16777343,1356507220),(25,2,16777343,1356859525),(24,0,16777343,1357469484),(25,1,16777343,1362918852),(26,1,16777343,1365847492),(27,1,16777343,1363082241),(26,0,16777343,1363021841),(28,1,16777343,1365847733),(28,0,16777343,1371403274);
...
CREATE TABLE `sys_menu` (
  ...
  KEY `rgt` (`rgt`),
  KEY `level` (`level`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='用nestedset保存树关系';

/*Data for the table `sys_menu` */

insert  into `sys_menu`(`id`,`root`,`lft`,`rgt`,`level`,`label`,`url`,`params`,`ajaxoptions`,`htmloptions`,`is_visible`,`group_code`,`label_en`,`link_to`) values (1,1,1,42,1,'虚菜单',NULL,NULL,NULL,NULL,1,'sys_menu','','route'),(2,1,2,9,2,'关于我们','/site/aboutUs',NULL,NULL,NULL,1,'sys_menu','','route'),(8,1,16,27,2,'客户服务','/site/services',NULL,NULL,NULL,1,'sys_menu','','route'),(9,1,28,31,2,'人力资源','/site/humanResource',NULL,NULL,NULL,1,'sys_menu','','route'),(10,1,32,37,2,'新手学院','/site/guide',NULL,NULL,NULL,1,'sys_menu',NULL,'route'),(11,1,38,39,2,'联系佳和','/site/contactUs',NULL,NULL,NULL,1,'sys_menu','','route'),(12,1,10,15,2,'新闻中心','/site/news',NULL,NULL,NULL,1,'sys_menu','','route'),(13,1,17,18,3,'产品介绍',NULL,NULL,NULL,NULL,1,'sys_menu','','route'),(14,1,19,20,3,'平台下载',NULL,NULL,NULL,NULL,1,'sys_menu','','route'),(15,1,21,22,3,'外汇投资',NULL,NULL,NULL,NULL,1,'sys_menu','','route'),(16,1,23,24,3,'IB经济商',NULL,NULL,NULL,NULL,1,'sys_menu','','route'),(17,1,5,6,3,'公司简介',NULL,NULL,NULL,NULL,1,'sys_menu',NULL,'page'),(18,1,7,8,3,'运营模式',NULL,NULL,NULL,NULL,1,'sys_menu',NULL,'page'),(19,1,3,4,3,'团队介绍',NULL,NULL,NULL,NULL,1,'sys_menu',NULL,'page'),(20,1,13,14,3,'行业新闻',NULL,NULL,NULL,NULL,1,'sys_menu',NULL,'pageList'),(21,1,11,12,3,'企业新闻',NULL,NULL,NULL,NULL,1,'sys_menu',NULL,'pageList'),(22,1,29,30,3,'企业招聘',NULL,NULL,NULL,NULL,1,'sys_menu','','route'),(23,1,33,34,3,'在线教程',NULL,NULL,NULL,NULL,1,'sys_menu',NULL,'pageList'),(24,1,35,36,3,'常见问题',NULL,NULL,NULL,NULL,1,'sys_menu','','route'),(25,1,25,26,3,'二十',NULL,NULL,NULL,NULL,1,'sys_menu','','route'),(26,1,40,41,2,'图片',NULL,NULL,NULL,NULL,1,'admin_menu',NULL,'route');
...
insert  into `user`(`id`,`username`,`password`,`icon_uri`,`email`,`activkey`,`superuser`,`status`,`create_at`,`lastvisit_at`) values (1,'yiqing','32ee7d239bcc2eff68f47ca70bd6e4a7',NULL,'webmaster@example.com','8abda1b47ccc436c2aaf3eb5912d3971',1,1,'2012-07-24 15:46:36','2014-03-10 00:41:11'),(2,'yiqing2','32ee7d239bcc2eff68f47ca70bd6e4a7',NULL,'66104992@qq.com','c1a5a5f7d1cc198d132d2d367ca08877',0,1,'2012-07-27 10:29:01','2013-12-30 16:54:12'),(3,'yiqing3','32ee7d239bcc2eff68f47ca70bd6e4a7',NULL,'yiqing_95@qq.com','f07550b610f3388b17ffc6b62aecb1ad',0,1,'2012-08-11 14:15:02','2013-02-10 16:15:44'),(5,'yiqing4','32ee7d239bcc2eff68f47ca70bd6e4a7',NULL,'yiqing95@qq.com','d57dc9f6edec567aa4dc0bb6a22bf41d',0,1,'2014-01-03 09:55:29','2014-01-03 01:59:51');
...
insert  into `user_profile`(`user_id`,`first_name`,`last_name`,`photo`) values (1,'Administrator','Admin','uploads/user/13577965701357796570.jpg'),(2,'qing','yii','uploads/user/13515238331351523833.jpg'),(3,'qing','yii','uploads/user/13518713151351871315.gif'),(5,'','','');
...
insert  into `yiisession`(`id`,`expire`,`data`,`user_id`) values ('p3mrvl5fvm6eroi1pd310r4g83',1394452206,'edcf6729b27f11f3657aa0c5df331f33__returnUrl|s:61:\"/my_github_old/MyGithubProjects/yiiSpace/album/view/id/18/u/1\";',0);
