...
class GroupTopicController extends BaseGroupController
{
    ...
    /**
     * admin for the specific group
     */
    public function actionAdmin4group()
    {
        $this->layout = false;
        ...
        if(isset($_GET['GroupTopic']))
            $model->attributes=$_GET['GroupTopic'];
      // $model->group = intval(request()->getParam('group'));

        $this->render('admin4group',array(
            'model'=>$model,
        ));
    }
    ...
    */
     ...
     * @return GroupTopic	 */
	public function loadModel($id,$modelClass='GroupTopic')
	{
	 ...
	 */
	protected function performAjaxValidation($model,$form='group-topic-form')
	{
